...
we do visibility check after every vertex split, and meanwhile we %ignore the RTT and
...
Next, we compare the screen-area based method with other two methods to justify our propose. 
