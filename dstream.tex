...
\section{Receiver-Driven Protocol}
    ...
    A vertex split will generate two new vertices and their screen-area need re-computation.
    ...
    %With the method introduced above, we can estimate the visual importance of each existed vertex,
    ...
    During the streaming, when the receiver satisfies with the rendering quality, it 
...
We test our method on various of meshes, viewpoints, and 
...
%Moreover, the vertex splits selected contribute
%less to the quality since the curve has a smaller slope even before the quality 
%stops increasing. 
...
Next, we compare the screen-area based method with other two methods. One is level-based
