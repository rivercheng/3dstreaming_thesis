...
\label{s:dstream:intro}
    ...
    %an image-based metric
    %similar 
    %to that proposed by Lindstrom and Turk \cite{353995}, using the %mean square error 
    %difference between the rendered images of the original mesh and reconstructed mesh.   
