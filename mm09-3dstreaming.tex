...
To simplify the model, we need to understand more about the user behaviors.
...
Then, we introduce step 2. In this step we need to determine $Pr(A_n |_{\textrm{current state}, A_n != A_p})$
