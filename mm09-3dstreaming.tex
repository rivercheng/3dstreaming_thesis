...
To address these two limitations, we propose a method to generate more synthetic traces in the next section.
...
``change'' is selected, the majority of selections (recall that more than 80\% of actions are ``continue'')
