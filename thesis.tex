...
\end{figure}
    ...
    is an example\footnote{For example, Dr. Andre Stork and his teams are working
    on a project named ``History in 3D'', http://www.fraunhofer.de/en/press/research-news/2009/11/history-in-3d.jsp.}. 
...
\end{figure}
  ...
  \label{s:intro:contributions}
    ...
    In implementing the receiver-driven protocol, we have three main problems.
    ...
    In next chapter, we introduce some backgrounds and related works.
...
\end{figure}
    ...
    with textures based on subsampling. 
    Their objective is to optimize the perceptial quality, which depends 
